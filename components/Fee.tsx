        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 lg:w-1/2 px-4 mb-8">
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
              ...
              <div className="p-6">
                <p className="text-3xl font-bold mb-4">主契約: 5,500円 小契約: 2,750円</p>
                <ul className="mb-6">
                  <li>主契約は法人全体で利用可能</li>
                  <li>小契約は個別の部署やチーム向け</li>
                </ul>
                <button className="w-full bg-green-400 text-white py-2 rounded hover:bg-green-600">
                  申し込む
                </button>
              </div>
            </div>
