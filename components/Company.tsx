    ...
    >
      ...
      <div className="container mx-auto max-w-7xl px-6 relative">
        ...
        <div className="text-center mb-20 opacity-0 animate-fade-in">
          <p className="text-blue-600 font-medium mb-4 tracking-wide">ABOUT US</p>
          <h2 className="font-extrabold text-4xl md:text-6xl mb-6 text-gray-800">Company</h2>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-16">
          {/* Company Info Card */}
          <div className={`w-full lg:w-1/2 bg-white rounded-2xl shadow-[0_0_50px_0_rgba(0,0,0,0.1)] p-8 lg:p-12 transition-all duration-700 ${
          ...
          {/* Map Section */}
          <div className={`w-full lg:w-1/2 transition-all duration-700 delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
