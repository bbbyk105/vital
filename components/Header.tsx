    ...
    <header className={`fixed top-0 left-0 w-full z-[50] transition-all duration-300
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link href="/" className="relative z-[60] flex items-center space-x-2">
            <Image
              src="/logo.png"
              alt="Company Logo"
              width={120}
          ...
          >
            <div className="relative flex flex-col items-center justify-center w-6 h-6">
              <span className={`absolute w-6 h-0.5 bg-gray-600 transform transition-all duration-300 ease-in-out
